function bindResetBtn(btnReset, localStorageName = '') {
    if (btnReset) {
    ...
    for (let g = 0, len = inputs.length; g < len; g++) {
        ...
        for (let i = 0, len = fields.length; i < len; i++) {
            ...
            for (let v = 0; v < valuesVals.length; v++) {
                ...
                valCache = isMulti ? settingsCache[currentVal] : valCache;
                ...
                if (type === 'textarea') {
                    ...
                    inputEl.checked = valCache === true ? true : false
                    if (valCache === false || !valCache) {
                    }
                ...
                if ((type === 'radio' || type === 'checkbox' || isMulti)) {
                    ...
                    let labeText = document.createTextNode(`${currentKey}`);
                ...
                inputEl.addEventListener(listener, (e) => {
                    ...
                    if (currentType === 'checkbox') {
                        ...
                        if (isArray) {
                            ...
                            if (current.checked) {
                                settings[currentName] = true
                            } else {
                                settings[currentName] = false
                            }
                        }
                    }
...
function appendInputs(inputs, selection = [], target, localStorageName = '') {
    ...
    // reset btn
    bindResetBtn(btnReset, localStorageName)
